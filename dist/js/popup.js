!(function (e) {
  function t(t) {
    for (
      var n, u, i = t[0], l = t[1], a = t[2], f = 0, p = [];
      f < i.length;
      f++
    )
      (u = i[f]),
  ...
  function (e, t, r) {
    ...
    o(function () {
      chrome.tabs.query({ active: !0, currentWindow: !0 }, function (e) {
        o("#url").text(e[0].url),
          o("#time").text(n().format("YYYY-MM-DD HH:mm:ss"));
      }),
        chrome.browserAction.setBadgeText({ text: u.toString() }),
        o("#countUp").click(() => {
          (u = c.increment(u)),
            chrome.browserAction.setBadgeText({ text: u.toString() });
        }),
        o("#changeBackground").click(() => {
          chrome.tabs.query({ active: !0, currentWindow: !0 }, function (e) {
            chrome.tabs.sendMessage(e[0].id, { color: "#555555" }, function (
              e
            ) {
